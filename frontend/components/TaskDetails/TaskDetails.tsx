...
export default function TaskDetails({
  ...
  const [learningStrategy, setLearningStrategy] = useState(
    card.learning_strategy ?? "Learning Strategies"
  );
  ...
  const [postTestGrade, setPostTestGrade] = useState(
  ...
  const isNotesEnabled =
    listName === "Reflection (Done)" || listName === "Controlling (Review)";
  const isPreTestEnabled = listName !== "Reflection (Done)";
  const isPostTestEnabled =
    listName === "Controlling (Review)" || listName === "Reflection (Done)";
            ...
            <div className="space-y-6">
              <div className="bg-white/80 dark:bg-slate-800/80 rounded-lg p-4 border border-indigo-200 dark:border-indigo-800 shadow-sm hover:shadow-md transition-all duration-300">
                ...
                <div className="space-y-4">
                  ...
                  />
                  <LearningStrategiesDropdown
                    strategy={learningStrategy}
                    onChange={handleLearningStrategyChange}
                  />
                </div>
              </div>
